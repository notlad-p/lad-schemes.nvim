...
M.get_highlights = function(scheme)
	...
	local highlights = {
		...
		-- text color
		["@markup.heading.1.markdown"] = { fg = theme.base0D },
		-- icon color
		RenderMarkdownH1 = { fg = theme.base0D },
		-- bg color (80% shade)
		RenderMarkdownH1Bg = { bg = "#18222f" },

		["@markup.heading.2.markdown"] = { fg = theme.base09 },
		RenderMarkdownH2 = { fg = theme.base09 },
		RenderMarkdownH2Bg = { bg = "#2f2a1c" },

		["@markup.heading.3.markdown"] = { fg = theme.base0B },
		RenderMarkdownH3 = { fg = theme.base0B },
		RenderMarkdownH3Bg = { bg = "#1a271f" },

		["@markup.heading.4.markdown"] = { fg = theme.base0E },
		RenderMarkdownH4 = { fg = theme.base0E },
		RenderMarkdownH4Bg = { bg = "#271b2f" },

		["@markup.heading.5.markdown"] = { fg = theme.base0A },
		RenderMarkdownH5 = { fg = theme.base0A },
		RenderMarkdownH5Bg = { bg = "#2f1e19" },

		["@markup.heading.6.markdown"] = { fg = theme.base08 },
		RenderMarkdownH6 = { fg = theme.base08 },
		RenderMarkdownH6Bg = { bg = "#301617" },
	}
	...
	for i, integration in ipairs(integrations) do
		local path = "lad-schemes.integrations." .. integration

		local ok, integration_hls = pcall(require, path)

		if ok then
			highlights = vim.tbl_deep_extend("force", integration_hls.get_hls(scheme), highlights)
		end
	end
	...
	return vim.tbl_deep_extend("force", highlights, polish_hl)
	-- return highlights
end
